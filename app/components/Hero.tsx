    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <div className="max-w-2xl animate-fade-in-up">
          <h1
            className="font-heading text-4xl font-bold text-accent sm:text-5xl lg:text-6xl"
            style={{ letterSpacing: "0.04em" }}
          >
            {t("welcomeTitle")}
          </h1>
          <p className="mt-6 max-w-xl font-body text-base leading-relaxed text-text/80 sm:text-lg">
            {t("welcomeSubtitle")}
          </p>
        </div>
